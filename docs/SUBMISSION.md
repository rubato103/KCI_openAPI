...
- ✅ 공식 MCP 레지스트리: `io.github.rubato103/kci-openapi-mcp` v0.1.2 (검색 가능)
- ✅ Claude Desktop 설치용 `.mcpb`: https://github.com/rubato103/KCI_openAPI/releases/download/v0.1.2/kci-openapi-mcp.mcpb
